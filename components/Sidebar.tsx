...
import { Users, PlusCircle, Printer, Settings, CreditCard, Home, LogOut, BarChart3, PackageCheck } from "lucide-react";
...
const navItems = [
  ...
  { href: "/admin/entregas", label: "Entrega Fotochecks", icon: PackageCheck },
